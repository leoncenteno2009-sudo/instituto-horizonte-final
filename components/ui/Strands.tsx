...
export default function Strands({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('WebGL context creation failed for Strands:', e);
      return;
    }
  ...
  }, [amplitude, dispersion, glassSize, glow, hueShift, intensity, opacity, refraction, saturation, scale, speed, spread, taper, thickness, waviness]);
